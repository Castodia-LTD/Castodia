...
import { useSafeguardingDashboard } from "@/hooks/care/safeguarding/useSafeguardingDashboard";
import type { CaseRiskLevel, CaseStatus } from "@/lib/care/safeguarding/types";
  ...
  return (
    <div className="mx-auto w-full max-w-[1500px] space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Link
          href="/care/manager/safeguarding/new"
          ...
          <div className="space-y-3">
            {filteredCases.map((safeguardingCase) => (
              <Link
                ...
                href={`/care/manager/safeguarding/${safeguardingCase.id}`}
