...
import { useSafeguardingCase } from "@/hooks/care/safeguarding/useSafeguardingCase";
import {
  addChronologyEntry,
...
import {
  ...
  DOCUMENT_CATEGORIES,
  REFERRAL_STATUSES,
} from "@/lib/care/safeguarding/constants";
import type {
  ActionPriority,
  ActionStatus,
  CaseCategory,
  ...
  if (!bundle) {
    return (
      <div className="mx-auto w-full max-w-4xl space-y-5 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <Link href="/care/manager/safeguarding" className="text-sm font-semibold text-teal-700 hover:underline">
    ...
    <div className="mx-auto w-full max-w-[1500px] space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <header className="space-y-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <Link href="/care/manager/safeguarding" className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-teal-700">
