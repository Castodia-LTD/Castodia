...
export default function ServiceUsersAdminPage() {
  ...
  async function loadServiceUsers() {
    const { data, error } = await supabase
      .from("service_users")
      .select(
        "id, full_name, house_name, photo_url, key_notes, allergies, communication_needs, risk_notes"
      )
      .eq("is_active", true)
      .order("full_name");
    ...
    <AppShell>
      <div className="mx-auto w-full max-w-screen-lg px-4 py-6">
        ...
        <p className="mt-2 text-slate-400">
          Create service users and maintain their profile information.
        </p>

        <div className="mt-8 rounded-3xl border border-white/10 bg-white/10 p-6 shadow-xl backdrop-blur space-y-4">
            ...
            <div className="mx-auto my-8 w-full max-w-screen-md rounded-3xl border border-white/10 bg-slate-950 p-6 shadow-2xl">
              ...
              <div className="mt-6 space-y-4">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditing({ ...editing, key_notes: e.target.value })
                  }
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditing({ ...editing, risk_notes: e.target.value })
                  }
