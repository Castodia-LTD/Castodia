...
function getWelcomeMessage(
  ...
  switch (accountType) {
    case "family":
      return "Finish setting up your secure Castodia Family access.";

    case "support":
      return "Finish setting up your Castodia support account.";

    case "manager":
      return "Finish setting up your Castodia manager account.";

    case "castodia_admin":
      return "Finish setting up your Castodia administrator account.";
