...
export async function POST(
  ...
  return NextResponse.json(
    ...
    if (requestingUserError || !requestingUser) {
      ...
      return NextResponse.json(
        {
          error: "Your platform session is invalid or expired.",
        },
        {
          status: 401,
        }
    ...
    if (requestingProfileError) {
      ...
      return NextResponse.json(
        {
          error:
            "Your platform permissions could not be checked.",
        },
        {
          status: 500,
        }
...
const isPlatformAdmin =
  requestingProfile?.role === "platform_admin" ||
