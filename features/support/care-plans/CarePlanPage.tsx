...
import { CarePlanReadView } from "@/components/shared/care-plans/CarePlanReadView";
import ServiceUserHubHeader from "@/features/manager/service-users/components/ServiceUserHubHeader";

import { getPublishedCarePlan } from "@/lib/service-user-hub/care-plans/api";
...
export default function SupportCarePlanPage() {
  ...
  function handleServiceUserChange(nextServiceUserId: string) {
    ...
    router.push(
      `/support/service-users/${nextServiceUserId}/care-plans`,
    );
  }
