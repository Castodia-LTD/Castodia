...
import { RiskRegister } from "@/components/support/risk-register/RiskRegister";
import ServiceUserHubHeader from "@/features/manager/service-users/components/ServiceUserHubHeader";

import { getRiskRegister } from "@/lib/service-user-hub/risk-register/api";
...
export default function RiskRegisterPage() {
  ...
  function handleServiceUserChange(nextServiceUserId: string) {
    ...
    router.push(
      `/support/service-users/${nextServiceUserId}/risk-assessments`,
    );
  }
