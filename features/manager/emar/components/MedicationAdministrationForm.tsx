...
export default function MedicationAdministrationForm({
  ...
  if (!serviceUserId) {
    return (
      <div className="rounded-2xl border border-red-500/20 bg-red-950/40 p-4 text-red-100">
        Missing service user ID.
      </div>
    );
  }
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/70 p-5 shadow-xl shadow-black/20">
      ...
      {loading ? (
        <p className="text-sm text-slate-400">Loading medication...</p>
      ) : (
        <>
          <div>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-400">{med.dose}</p>
