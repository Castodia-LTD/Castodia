...
import { RiskRegister } from "@/components/manager/risk-register/RiskRegister";
import ServiceUserHubHeader from "@/features/manager/service-users/components/ServiceUserHubHeader";

import { getCurrentRiskRegisterManager } from "@/lib/service-user-hub/risk-register/api";
...
export default function RiskRegisterPage() {
  ...
  function handleServiceUserChange(nextServiceUserId: string) {
    ...
    router.push(
      `/manager/service-users/${nextServiceUserId}/risk-assessments`,
    );
  }
