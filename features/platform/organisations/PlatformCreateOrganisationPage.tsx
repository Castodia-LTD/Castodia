...
import { availableModules } from "@/lib/modules/availableModules";
import { availableTimelineCategories } from "@/lib/timelines/availableTimelineCategories";

export default function PlatformCreateOrganisationPage() {
  ...
  async function createOrganisation() {
    ...
    router.push(`/platform/organisations/${organisationId}`);
  }
