...
export default function ManageAdminUsersPage() {
      ...
      if (photo) {
        try {
          ...
          const updateResponse = await authenticatedFetch(
            `/api/platform/users/${result.user.id}`,
            {
              method: "PATCH",
              headers: {
                "Content-Type": "application/json",
  ...
  return (
    <CastodiaPageShell
      ...
      description="Create and manage Castodia Owner and Castodia Administrator accounts."
      maxWidth="wide"
    >
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Update profile details and platform access.
                </p>
              </div>
