...
const hubSections = [
  
  {
    label: "Employment",
    href: (id: string) =>
      `/care/manager/staff/${id}/employment`,
    icon: BriefcaseBusiness,
  },
  {
    label: "Training",
    href: () => "/care/manager/staff/training",
    icon: GraduationCap,
  },
  {
    label: "Competencies",
  ...
  },
  {
    label: "Documents",
    href: (id: string) =>
      `/care/manager/staff/${id}/documents`,
    icon: FileText,
  },
  {
...
export default function StaffHubPage({
  ...
  const outstandingActions = useMemo(() => {
    ...
    if (!employment) {
      actions.push({
        ...
        href: `/care/manager/staff/${staff.id}/employment`,
      });
    }
    ...
    if (documentSummary.expired > 0) {
      actions.push({
        ...
        href: `/care/manager/staff/${staff.id}/documents`,
      });
    }
  ...
  const baseHref = `/care/manager/staff/${staff.id}`;
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <Link href="/care/manager/admin/staff">
          <CastodiaButton>
      ...
      <section>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <Link href="/care/manager/staff/training">
          ...
          <Link href="/care/manager/staff/competencies">
            <CastodiaCard className="h-full transition hover:-translate-y-0.5 hover:shadow-md">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-medium text-slate-500">
