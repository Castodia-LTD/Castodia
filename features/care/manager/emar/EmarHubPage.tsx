...
const hubSections = [
  {
    label: "Medications",
    href: (id: string) =>
      `/care/manager/emar/profiles?serviceUserId=${id}`,
    icon: Pill,
  },
  {
  label: "Dose Management",
  href: (id: string) =>
    `/care/manager/emar/dose?serviceUserId=${id}`,
  icon: SlidersHorizontal,
},
  {
    label: "Stock",
    href: (id: string) =>
      `/care/manager/emar/${id}/stock`,
    icon: PackageSearch,
  },
  {
    label: "Audit",
    href: (id: string) =>
      `/care/manager/emar/${id}/audit`,
    icon: FileClock,
  },
];
...
export default function EmarHubPage({
  ...
  const outstandingActions = useMemo(() => {
    ...
    if (
      ...
      actions.push({
        ...
        href: `/care/manager/emar/profiles?serviceUserId=${serviceUser.id}`,
      });
    }
    ...
    if (
      ...
      actions.push({
        ...
        href: `/care/manager/emar/${serviceUser.id}/titration`,
      });
    }
    ...
    if (
      ...
      actions.push({
        ...
        href: `/care/manager/emar/${serviceUser.id}/audit`,
      });
    }
  ...
  const baseHref = `/care/manager/emar/${serviceUser.id}`;
    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <Link
            href={`/care/manager/emar/${serviceUser.id}/administration`}
          >
            <CastodiaCard className="h-full transition hover:-translate-y-0.5 hover:shadow-md">
              <div className="flex items-start justify-between gap-4">
                <div>
          ...
          <Link
            href={`/care/manager/emar/${serviceUser.id}/history`}
          >
            <CastodiaCard className="h-full transition hover:-translate-y-0.5 hover:shadow-md">
              <div className="flex items-start justify-between gap-4">
                <div>
